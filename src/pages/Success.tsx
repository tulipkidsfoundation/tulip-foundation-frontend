              ...
              <div className="p-8">
                ...
                <div className="mt-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Questions? Contact us at <span className="text-tulip font-medium">info@tulipkidsfoundation.org</span> or call <span className="text-tulip font-medium">+1 (408) 930 – 1862</span>
                  </p>
                </div>
              </div>
            </div>
